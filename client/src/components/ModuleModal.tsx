        ...
        <div className="mt-6 space-y-4">
          ...
          <Card>
            ...
            <CardContent className="grid md:grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-gray-500 mb-1">Время внедрения</p>
                <p className="font-semibold">{details.implementation}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500 mb-1">Стоимость</p>
                <p className="font-semibold text-telegram">{details.price}</p>
              </div>
            </CardContent>
          </Card>
