...
const allModules = [
    ...
    // КОНТЕНТ (10 Модулей)
    {
        id: 'content-stories',
        category: 'КОНТЕНТ',
        title: 'Кружочки сторис с интерактивными элементами',
        description: 'Эффективный инструмент вовлечения пользователей через короткий визуальный контент в Telegram Mini App.',
        features: [
            "Вертикальный формат историй: Полноэкранные истории в стиле Instagram с плавной навигацией.",
            "Разнообразный контент: Поддержка фото, видео, анимаций, текста и интерактивных элементов.",
            "Интерактивные call-to-action: Встроенные кнопки, формы, опросы и ссылки для целевых действий.",
            "Аналитика просмотров: Детальная статистика по охвату, завершенности и взаимодействиям.",
            "Интеграция с Telegram: Возможность делиться сториз в личные чаты и каналы."
        ]
    },
    {
        id: 'content-360-galleries',
        category: 'КОНТЕНТ',
        title: 'Галереи с 360° просмотром',
        description: 'Высокотехнологичное решение для интерактивной демонстрации контента в Telegram Mini App.',
        features: [
            "Объемная визуализация: Плавный круговой обзор объектов с контролем угла и масштаба.",
            "Оптимизированная загрузка: Прогрессивное отображение с учетом скорости интернета.",
            "Интерактивные хотспоты: Интеграция кликабельных точек с детальной информацией.",
            "Мультиракурсное фото: Автоматическая сборка 360° вида из серии обычных фотографий.",
            "Шеринг в Telegram: Возможность поделиться интерактивным видом напрямую в чаты."
        ]
    },
    {
        id: 'content-video-player',
        category: 'КОНТЕНТ',
        title: 'Видео-плеер с адаптивным качеством',
        description: 'Высокопроизводительное решение для просмотра видеоконтента в Telegram Mini App.',
        features: [
            "Умная адаптация битрейта: Автоматическая регулировка качества видео.",
            "Бесшовное переключение: Плавный переход между разрешениями без прерывания.",
            "Интеллектуальная буферизация: Предзагрузка контента для плавного просмотра.",
            "Расширенные контролы: Управление скоростью, закладки, картинка-в-картинке.",
            "Энергоэффективное воспроизведение: Оптимизация потребления заряда батареи."
        ]
    },
    {
        id: 'content-podcasts',
        category: 'КОНТЕНТ',
        title: 'Аудио-подкасты с плейлистами',
        description: 'Комплексное решение для создания и прослушивания аудиоконтента в Telegram Mini App.',
        features: [
            "Фоновое воспроизведение: Прослушивание при свернутом приложении или блокировке экрана.",
            "Умные плейлисты: Автоматическое формирование подборок на основе интересов.",
            "Таймкоды и главы: Навигация по разделам аудиоконтента.",
            "Регулировка темпа: Изменение скорости воспроизведения без искажения голоса.",
            "Синхронизация позиции: Сохранение прогресса прослушивания между устройствами."
        ]
    },
    {
        id: 'content-blog',
        category: 'КОНТЕНТ',
        title: 'Блог с SEO-оптимизацией для Telegram',
        description: 'Адаптированная для Telegram Mini App система публикации и распространения текстового контента.',
        features: [
            "Встроенный редактор: Создание форматированных статей с медиаконтентом.",
            "Каналы распространения: Автоматическая публикация в Telegram-каналы и группы.",
            "Рекомендательная система: Персонализированные предложения релевантных статей.",
            "Статистика и аналитика: Информация о просмотрах, времени чтения и вовлеченности.",
            "Тегирование и категоризация: Умная организация контента для удобной навигации."
        ]
    },
    {
        id: 'content-storage',
        category: 'КОНТЕНТ',
        title: 'Файловое хранилище с правами доступа',
        description: 'Защищенная система хранения и обмена документами в экосистеме Telegram.',
        features: [
            "Облачное хранение: Безопасное размещение файлов с доступом из любой точки.",
            "Гибкие права доступа: Многоуровневая система разрешений для разных пользователей.",
            "Защита контента: Шифрование данных, водяные знаки, контроль скачиваний.",
            "Версионность документов: История изменений с возможностью восстановления.",
            "Интеграция с Telegram: Прямая отправка файлов из хранилища в чаты и каналы."
        ]
    },
    {
        id: 'content-comments',
        category: 'КОНТЕНТ',
        title: 'Система комментариев и обсуждений',
        description: 'Интерактивный инструмент для организации дискуссий вокруг контента в Telegram Mini App.',
        features: [
            "Многоуровневые треды: Структурированные цепочки комментариев.",
            "Интеграция с профилем Telegram: Использование аккаунтов без доп. регистрации.",
            "Умная модерация: Автоматическое выявление токсичного контента с помощью ML.",
            "Реакции и рейтинги: Система оценки комментариев с визуальной обратной связью.",
            "Уведомления в Telegram: Мгновенные оповещения об ответах и упоминаниях."
        ]
    },
    {
        id: 'content-livestreams',
        category: 'КОНТЕНТ',
        title: 'Лайвстримы и онлайн-трансляции',
        description: 'Полнофункциональная платформа для проведения прямых эфиров через Telegram Mini App.',
        features: [
            "HD-стриминг с низкой задержкой: Высококачественная передача видео и аудио.",
            "Интерактивные элементы: Встроенные опросы, вопросы, реакции и донаты.",
            "Многопоточная трансляция: Подключение нескольких ведущих и гостей.",
            "Автоматическая запись: Сохранение трансляций с последующей обработкой.",
            "Оповещения в Telegram: Автоматическое уведомление подписчиков о начале."
        ]
    },
    {
        id: 'content-surveys',
        category: 'КОНТЕНТ',
        title: 'Интерактивные опросы и голосования',
        description: 'Многофункциональный инструмент для сбора мнений и обратной связи в Telegram Mini App.',
        features: [
            "Разнообразные форматы: Множество типов вопросов от простого выбора до шкал.",
            "Визуализация результатов: Наглядное отображение статистики в реальном времени.",
            "Условная логика: Адаптивное изменение последовательности вопросов.",
            "Приватность и анонимность: Гибкие настройки конфиденциальности ответов.",
            "Геймификация участия: Система вознаграждений для повышения активности."
        ]
    },
    {
        id: 'content-moderation',
        category: 'КОНТЕНТ',
        title: 'Модерация и фильтрация контента',
        description: 'Интеллектуальная система контроля качества пользовательского контента в Telegram Mini App.',
        features: [
            "AI-анализ контента: Автоматическое выявление нежелательных материалов.",
            "Многоуровневая проверка: Комбинация автоматической и ручной модерации.",
            "Фильтры токсичности: Настраиваемые правила для определения неприемлемых комментариев.",
            "Система репортов: Возможность пользователям сообщать о нарушениях.",
            "Прозрачные правила: Четкие community guidelines с авто-предупреждениями."
        ]
    },
    // ФИНТЕХ (12 Модулей)
    {
        ...
        description: 'Инновационная платежная система с использованием внутренней валюты Telegram.',
        features: [
            "Нативная интеграция: Прямое подключение к экосистеме Telegram Stars.",
            "Нулевая комиссия: Отсутствие сборов за использование Stars в качестве платежа.",
            "Мгновенные транзакции: Моментальное зачисление средств без задержек.",
            "Автоматическая конвертация: Мгновенный перевод Stars в рубли для вывода.",
            "Защищенные транзакции: Многоуровневая система безопасности от Telegram."
        ]
    },
    {
        id: 'fintech-stripe',
        category: 'ФИНТЕХ',
        title: 'Международные платежи через Stripe',
        description: 'Глобальное платежное решение для пользователей Telegram Mini App по всему миру.',
        features: [
            "Мультивалютный прием: Поддержка более 135 валют с авто-конвертацией.",
            "Интернациональная совместимость: Принятие всех популярных международных карт.",
            "Умная антифрод-система: Защита от мошенничества с Stripe Radar.",
            "PCI DSS соответствие: Полное соответствие стандартам безопасности.",
            "Интеграция с Telegram Payments: Бесшовное подключение к официальному API."
        ]
    },
    {
        id: 'fintech-russian-payments',
        category: 'ФИНТЕХ',
        title: 'Российские платежи YooKassa, СБП',
        description: 'Оптимизированное платежное решение для российской аудитории Telegram Mini App.',
        features: [
            "Полная интеграция с СБП: Мгновенные переводы с минимальной комиссией.",
            "Поддержка всех популярных методов: Банковские карты, электронные кошельки, QR.",
            "Автоплатежи и подписки: Настройка регулярных списаний.",
            "Фискализация: Автоматическая генерация и отправка чеков согласно 54-ФЗ.",
            "Смарт-холдинги: Временная блокировка средств."
        ]
    },
    {
        id: 'fintech-crypto',
        category: 'ФИНТЕХ',
        title: 'Криптовалюты',
        description: 'Инновационная система приема цифровых активов в Telegram Mini App.',
        features: [
            "Мультивалютный криптокошелек: Поддержка Bitcoin, Ethereum, TON и токенов.",
            "Интеграция с TON: Прямое взаимодействие с блокчейн-экосистемой Telegram.",
            "Автоматическая конвертация: Мгновенное преобразование криптовалют в фиат.",
            "Крипто-кэшбэк: Система вознаграждений пользователей токенами за активность.",
            "Моментальная верификация: Подтверждение транзакций в реальном времени."
        ]
    },
    {
        id: 'fintech-gopay',
        category: 'ФИНТЕХ',
        title: 'GoPay для азиатских рынков',
        description: 'Специализированное платежное решение для пользователей Telegram из стран Юго-Восточной Азии.',
        features: [
            "Локальные методы оплаты: Интеграция с Alipay, WeChat Pay, GrabPay.",
            "Региональные банковские интеграции: Прямое подключение к популярным API.",
            "Мультиязычный интерфейс: Поддержка основных языков региона.",
            "Оптимизация транзакций: Минимизация международных комиссий.",
            "Локальная фискализация: Соответствие налоговым требованиям региона."
        ]
    },
    {
        id: 'fintech-subscriptions',
        category: 'ФИНТЕХ',
        title: 'Система подписок с автопродлением',
        description: 'Комплексное решение для управления регулярными платежами в Telegram Mini App.',
        features: [
            "Гибкие модели подписок: Настройка различных периодов (еженедельно, ежемесячно).",
            "Пробные периоды: Автоматизация бесплатного доступа с переходом на платный тариф.",
            "Умные напоминания: Заблаговременные уведомления через Telegram перед списанием.",
            "Управление жизненным циклом: Автоматизация апгрейдов, даунгрейдов и отмены.",
            "Защита от отказов: Интеллектуальная система повторных попыток списания."
        ]
    },
    {
        ...
        description: 'Комплексная система финансового анализа и отчетности для Telegram Mini App.',
        features: [
            "Многомерная аналитика доходов: Разбивка поступлений по категориям, продуктам и каналам.",
            "Предиктивные финансовые модели: Прогнозирование будущих доходов.",
            "Когортный анализ: Отслеживание финансовых показателей по группам для оценки LTV.",
            "Мультивалютная консолидация: Автоматический пересчет в единую валюту.",
            "Настраиваемые дашборды: Визуализация ключевых финансовых метрик."
        ]
    },
    {
        id: 'fintech-documents',
        category: 'ФИНТЕХ',
        title: 'Электронные чеки и документооборот',
        description: 'Автоматизированная система фискализации и управления документами для Telegram Mini App.',
        features: [
            "Онлайн-кассы и ОФД: Полная интеграция с сервисами фискализации по 54-ФЗ.",
            "Автоматическая отправка чеков: Доставка фискальных документов через Telegram и email.",
            "Электронный документооборот: Генерация, подписание и хранение договоров и актов.",
            "Юридически значимый ЭДО: Интеграция с операторами для обмена документами.",
            "Архивация и поиск: Централизованное хранилище с быстрым доступом."
        ]
    },
    {
        id: 'fintech-multicurrency',
        category: 'ФИНТЕХ',
        title: 'Мультивалютность и конвертация',
        description: 'Глобальное решение для работы с разными валютами в Telegram Mini App.',
        features: [
            "Автоматическая конвертация: Пересчет цен в предпочитаемую валюту.",
            "Динамические курсы обмена: Обновление курсов в реальном времени.",
            "Мультивалютные кошельки: Хранение балансов в разных валютах.",
            "Прозрачные комиссии: Четкое отображение всех сборов.",
            "Налоговая отчетность: Автоматический расчет налоговых обязательств."
        ]
    },
    {
        id: 'fintech-escrow',
        category: 'ФИНТЕХ',
        title: 'Эскроу-сервис для безопасных сделок',
        description: 'Надежная система защиты для проведения P2P-транзакций в Telegram Mini App.',
        features: [
            "Защищенные платежи: Блокирование средств на промежуточном счете.",
            "Пользовательская верификация: Многоуровневая проверка личности участников.",
            "Настраиваемые условия: Гибкая система определения требований для разблокировки.",
            "Арбитраж споров: Формализованная процедура разрешения конфликтов.",
            "История транзакций: Полная прозрачность всех этапов сделки."
        ]
    },
    {
        id: 'fintech-refunds',
        category: 'ФИНТЕХ',
        title: 'Автоматические возвраты и рефанды',
        description: 'Интеллектуальная система управления возвратами в Telegram Mini App.',
        features: [
            "Самообслуживание клиентов: Запрос возврата через интерфейс без поддержки.",
            "Настраиваемые политики: Гибкие правила автоматического одобрения/отклонения.",
            "Частичные возмещения: Пропорциональный возврат средств.",
            "Мультиканальный процесс: Обработка возвратов независимо от способа оплаты.",
            "Аналитика причин: Сбор и анализ данных о причинах возвратов."
        ]
    },
    {
        id: 'fintech-banking-api',
        category: 'ФИНТЕХ',
        title: 'Интеграция с банковскими API',
        description: 'Глубокое подключение к финансовой инфраструктуре для расширения возможностей Telegram Mini App.',
        features: [
            "Доступ к Open Banking: Прямое подключение к банковским API с согласия пользователя.",
            "Проверка балансов: Мониторинг средств в реальном времени.",
            "Автоплатежи и подписки: Настройка регулярных списаний с банковского счета.",
            "Выписки и история: Агрегация финансовой информации из разных банков.",
            "Уведомления о транзакциях: Мгновенные оповещения о движении средств."
        ]
    },
    // СЕРВИСЫ И БРОНИРОВАНИЕ (12 Модулей)
    {
        id: 'services-profiles',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'Профили специалистов с портфолио и отзывами',
        description: 'Комплексное решение для представления экспертов и специалистов внутри Telegram Mini App.',
        features: [
            "Расширенные профессиональные карточки: Детальная информация об опыте и навыках.",
            "Многоформатное портфолио: Галереи проектов с фото, видео и интерактивными элементами.",
            "Система верификации: Многоуровневая проверка профессиональных навыков.",
            "Отзывы с рейтингами: Детализированная система обратной связи от реальных клиентов.",
            "Мгновенная коммуникация: Прямой контакт со специалистом через Telegram."
        ]
    },
    {
        id: 'services-realtime-booking',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'Онлайн-запись с календарем в реальном времени',
        description: 'Интеллектуальная система управления расписанием и записями клиентов в Telegram Mini App.',
        features: [
            "Двусторонняя синхронизация: Обмен данными с календарями Google, Apple, Outlook.",
            "Автоматическая блокировка слотов: Исключение двойных записей.",
            "Интеллектуальные напоминания: Многоступенчатая система уведомлений через Telegram Bot.",
            "Адаптивное отображение: Интуитивно понятный календарь с визуализацией загрузки.",
            "Интеграция с платежами: Возможность предоплаты услуг при бронировании."
        ]
    },
    {
        id: 'services-ai-chatbot',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'AI чат-бот с интеграцией OpenAI/Dialogflow',
        description: 'Интеллектуальный виртуальный помощник для автоматизации коммуникаций в Telegram Mini App.',
        features: [
            "Нейросетевое ядро: Интеграция с моделями OpenAI GPT или Google Dialogflow.",
            "Контекстуальное понимание: Сохранение и анализ контекста для осмысленной беседы.",
            "Персонализированные ответы: Адаптация коммуникации под профиль пользователя.",
            "Омниканальность: Бесшовное взаимодействие между Mini App и обычными диалогами.",
            "Расширяемая база знаний: Система самообучения с возможностью добавления информации."
        ]
    },
    {
        id: 'services-ticket-system',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'Система тикетов поддержки с приоритизацией',
        description: 'Эффективное решение для структурированной обработки обращений клиентов в Telegram.',
        features: [
            "Умная категоризация: Автоматическая классификация обращений по типу и срочности.",
            "Интеллектуальная маршрутизация: Направление запросов компетентным специалистам.",
            "SLA-мониторинг: Отслеживание времени реакции и решения с эскалацией.",
            "Единая история обращений: Полный контекст всех взаимодействий с клиентом.",
            "Интеграция с Telegram: Создание и отслеживание тикетов прямо из мессенджера."
        ]
    },
    {
        id: 'services-push-notifications',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'Автоматические push-уведомления',
        description: 'Комплексная система целевых коммуникаций с пользователями Telegram Mini App.',
        features: [
            "Таргетированные сообщения: Персонализированные уведомления на основе поведения.",
            "Мультиканальность: Синхронизированная доставка через Telegram, push, email и SMS.",
            "Триггерные цепочки: Автоматические последовательности сообщений.",
            "A/B тестирование: Сравнение эффективности разных вариантов текста и времени.",
            "Аналитика эффективности: Детальная статистика по доставке и конверсиям."
        ]
    },
    {
        id: 'services-waitlist',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'Лист ожидания с автоматическими уведомлениями',
        description: 'Интеллектуальная система управления очередями и дефицитными ресурсами в Telegram Mini App.',
        features: [
            "Умное распределение очереди: Оптимизация порядка с учетом приоритета.",
            "Прогнозирование времени: Расчет примерного времени ожидания.",
            "Мгновенные уведомления: Автоматическая отправка сообщений через Telegram.",
            "Управление статусом: Возможность приостановки или отмены ожидания.",
            "Контекстуальный приоритет: Динамическое изменение позиции в очереди."
        ]
    },
    {
        id: 'services-resource-management',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'Управление ресурсами и временными слотами',
        description: 'Комплексное решение для оптимизации распределения ограниченных ресурсов в Telegram Mini App.',
        features: [
            "Централизованное планирование: Единая панель управления всеми ресурсами.",
            "Динамическая доступность: Автоматическое обновление статуса ресурсов.",
            "Интеллектуальное распределение: Алгоритмическая оптимизация назначений.",
            "Конфликт-менеджмент: Автоматическое выявление и разрешение накладок.",
            "Аналитика утилизации: Подробная статистика использования ресурсов."
        ]
    },
    {
        id: 'services-group-booking',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'Групповые и индивидуальные записи',
        description: 'Гибкое решение для организации различных форматов обслуживания клиентов в Telegram.',
        features: [
            "Многоформатное бронирование: Единая система для индивидуальных и групповых записей.",
            "Умное формирование групп: Автоматический подбор участников по параметрам.",
            "Динамическое управление лимитами: Настраиваемые ограничения по количеству.",
            "Листы ожидания: Организация очереди на групповые мероприятия.",
            "Групповая коммуникация: Создание временных чатов в Telegram."
        ]
    },
    {
        id: 'services-time-blocking',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'Блокировка времени и исключения',
        description: 'Интеллектуальная система управления доступностью и расписанием в Telegram Mini App.',
        features: [
            "Гибкое планирование: Настройка рабочих часов, перерывов и выходных.",
            "Рекуррентные блокировки: Создание регулярно повторяющихся недоступных периодов.",
            "Специальные исключения: Возможность создания временных отклонений.",
            "Календарь праздников: Автоматический учет официальных выходных.",
            "Интеграция с Telegram-календарем: Синхронизация блокировок."
        ]
    },
    {
        ...
        description: 'Многоуровневая система предотвращения пропущенных встреч в экосистеме Telegram.',
        features: [
            "Умное расписание уведомлений: Каскадные напоминания в оптимальные моменты.",
            "Интерактивные сообщения: Возможность подтверждения/переноса/отмены из уведомления.",
            "Персонализированный контент: Адаптация текста под тип встречи.",
            "Подготовительная информация: Включение в напоминания полезных данных.",
            "Геолокационный контекст: Расчет оптимального времени выезда с учетом трафика."
        ]
    },
    {
        id: 'services-video-consultations',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'Видео-консультации и телемедицина',
        description: 'Профессиональная платформа для проведения удаленных консультаций через Telegram.',
        features: [
            "Высококачественное видеосоединение: Стабильное HD-видео с минимальной задержкой.",
            "Защищенный канал связи: Шифрование всех данных и соответствие требованиям.",
            "Расширенный функционал: Демонстрация экрана, запись сессии (с согласия).",
            "Виртуальная комната ожидания: Подготовка к консультации через Telegram Bot.",
            "Медицинская интеграция: Подключение к системам электронных медицинских карт."
        ]
    },
    {
        id: 'services-calendar-integration',
        category: 'СЕРВИСЫ И БРОНИРОВАНИЕ',
        title: 'Интеграция с календарями Google/Outlook',
        description: 'Бесшовная синхронизация расписания между Telegram Mini App и популярными календарными сервисами.',
        features: [
            "Двунаправленная синхронизация: Мгновенное отражение изменений.",
            "Умная обработка конфликтов: Автоматическое разрешение наложений.",
            "Выборочная публикация: Настраиваемые фильтры для отображения событий.",
            "Кросс-платформенные уведомления: Координированная система напоминаний.",
            "Корпоративная интеграция: Подключение к корпоративным календарям."
        ]
    },
    // ИНТЕГРАЦИИ (9 Модулей)
    {
        id: 'integrations-crm',
        category: 'ИНТЕГРАЦИИ',
        title: 'Интеграция с CRM',
        description: 'Бесшовное соединение Telegram Mini App с популярными системами управления взаимоотношениями с клиентами.',
        features: [
            "Двусторонняя синхронизация: Автоматический обмен данными о клиентах.",
            "Объединенный профиль клиента: Консолидация информации из Telegram с данными CRM.",
            "Трекинг коммуникаций: Фиксация всех взаимодействий в единой истории.",
            "Триггерные сценарии: Запуск автоматизированных последовательностей в CRM.",
            "Омниканальные кампании: Координация маркетинговых активностей."
        ]
    },
    {
        id: 'integrations-erp',
        category: 'ИНТЕГРАЦИИ',
        title: 'Подключение к ERP системам',
        description: 'Глубокая интеграция Telegram Mini App с корпоративными системами планирования ресурсов.',
        features: [
            "Синхронизация данных: Обмен информацией о продуктах, заказах и клиентах.",
            "Управление запасами: Актуализация данных о наличии товаров в реальном времени.",
            "Автоматизация бизнес-процессов: Запуск рабочих потоков в ERP через действия в Mini App.",
            "Статусы и уведомления: Отслеживание изменений в ERP с оповещением в Telegram.",
            "Защищенный доступ: Безопасное подключение к корпоративным системам."
        ]
    },
    {
        id: 'integrations-external-api',
        category: 'ИНТЕГРАЦИИ',
        title: 'API для внешних сервисов',
        description: 'Гибкая система расширения функциональности Telegram Mini App через подключение к сторонним сервисам.',
        features: [
            "Универсальный REST API: Стандартизированный интерфейс для взаимодействия.",
            "Документированные эндпоинты: Подробное описание методов для интеграции.",
            "OAuth авторизация: Безопасная аутентификация с разграничением прав.",
            "Webhooks и коллбэки: Система уведомлений о событиях в реальном времени.",
            "Песочница для тестирования: Изолированная среда для отладки интеграций."
        ]
    },
    {
        ...
        description: 'Интеллектуальная система реагирования на события в Telegram Mini App.',
        features: [
            "Настраиваемые триггеры: Широкий спектр событий, запускающих действия.",
            "Условная логика: Комплексные правила для определения реакции на события.",
            "Мультисервисные сценарии: Организация цепочек действий в нескольких системах.",
            "Низкокодовый редактор: Визуальный интерфейс для создания автоматизаций.",
            "Мониторинг и логирование: Отслеживание выполнения процессов с детальной историей."
        ]
    },
    {
        id: 'integrations-cloud-storage',
        category: 'ИНТЕГРАЦИИ',
        title: 'Синхронизация с облачными хранилищами',
        description: 'Бесшовная интеграция Telegram Mini App с популярными облачными сервисами.',
        features: [
            "Двунаправленный обмен файлами: Синхронизация с Google Drive, Dropbox, OneDrive.",
            "Умное кеширование: Оптимизация доступа к часто используемым файлам.",
            "Избирательная синхронизация: Настройка конкретных папок и типов файлов.",
            "Версионность документов: Отслеживание изменений файлов.",
            "Коллективный доступ: Управление разрешениями пользователей Telegram."
        ]
    },
    {
        ...
        description: 'Объединение коммуникационных каналов Telegram и email для комплексного управления сообщениями.',
        features: [
            "Унифицированный инбокс: Объединение входящих из Telegram и email.",
            "Умная категоризация: Автоматическая сортировка писем по важности.",
            "Отправка из Telegram: Возможность составления и отправки email из Mini App.",
            "Синхронизация контактов: Объединение адресных книг.",
            "Фильтрация спама: Многоуровневая защита от нежелательных сообщений."
        ]
    },
    {
        id: 'integrations-analytics-systems',
        category: 'ИНТЕГРАЦИИ',
        title: 'Подключение к системам аналитики',
        description: 'Глубокая интеграция Telegram Mini App с профессиональными платформами бизнес-аналитики.',
        features: [
            "Унифицированный сбор данных: Передача событий в Google Analytics, Firebase, Amplitude.",
            "Пользовательские атрибуты: Обогащение аналитики данными из Telegram.",
            "Кросс-платформенное отслеживание: Связывание активности пользователей.",
            "Настраиваемые конверсии: Гибкое определение целевых действий.",
            "Расширенные отчеты: Генерация детальной аналитики."
        ]
    },
    {
        id: 'integrations-mobile-api',
        category: 'ИНТЕГРАЦИИ',
        title: 'API для мобильных приложений',
        description: 'Комплексное решение для расширения Telegram Mini App через нативные мобильные приложения.',
        features: [
            "SDK для iOS и Android: Готовые библиотеки для быстрой интеграции.",
            "Единая система авторизации: Бесшовная аутентификация через Telegram.",
            "Синхронизация данных: Обмен информацией между Mini App и нативными приложениями.",
            "Push-уведомления: Кроссплатформенная система оповещений.",
            "Deep linking: Умные ссылки для перехода между Telegram и нативными приложениями."
        ]
    }
];
...
function getModuleIcon(moduleTitle: string, category: string): JSX.Element {
    ...
    if (lowerTitle.includes('база знаний') && category === 'ОБРАЗОВАНИЕ') return <Library className="w-8 h-8 text-telegram" />;
    ...
    if (lowerTitle.includes('база знаний') && category !== 'ОБРАЗОВАНИЕ') return <Database className="w-8 h-8 text-telegram" />;
    ...
    // КОНТЕНТ
    if (lowerTitle.includes('сторис')) return <Aperture className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('галереи')) return <Camera className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('видео-плеер')) return <Video className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('подкасты')) return <Headphones className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('блог')) return <PenTool className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('файловое хранилище')) return <Cloud className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('комментариев')) return <MessageSquare className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('лайвстримы')) return <Presentation className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('опросы')) return <MessageCircleQuestion className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('модерация')) return <ShieldCheck className="w-8 h-8 text-telegram" />;

    // ФИНТЕХ
    if (lowerTitle.includes('stars')) return <Star className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('stripe')) return <Globe className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('yookassa')) return <HandCoins className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('криптовалюты')) return <Bitcoin className="w-8 h-8 text-telegram" />; // Предполагаем наличие иконки
    if (lowerTitle.includes('gopay')) return <Globe className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('подписок')) return <Repeat className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('финансовая аналитика')) return <BarChart3 className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('чеки')) return <FileText className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('мультивалютность')) return <DollarSign className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('эскроу')) return <Lock className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('возвраты')) return <Undo2 className="w-8 h-8 text-telegram" />; // Предполагаем наличие иконки
    if (lowerTitle.includes('банковскими api')) return <Landmark className="w-8 h-8 text-telegram" />; // Предполагаем наличие иконки

    // СЕРВИСЫ И БРОНИРОВАНИЕ
    if (lowerTitle.includes('профили специалистов')) return <Users2 className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('онлайн-запись')) return <Calendar className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('ai чат-бот')) return <Bot className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('тикетов')) return <Ticket className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('push-уведомления')) return <Bell className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('лист ожидания')) return <History className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('управление ресурсами')) return <Settings className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('групповые и индивидуальные')) return <Group className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('блокировка времени')) return <CalendarOff className="w-8 h-8 text-telegram" />; // Предполагаем наличие иконки
    if (lowerTitle.includes('напоминания о встречах')) return <Bell className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('видео-консультации')) return <Video className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('интеграция с календарями')) return <Calendar className="w-8 h-8 text-telegram" />;

    // ИНТЕГРАЦИИ
    if (lowerTitle.includes('crm')) return <Users2 className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('erp')) return <Building2 className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('api для внешних')) return <Code2 className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('вебхуки')) return <Webhook className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('облачными хранилищами')) return <Cloud className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('почтовыми сервисами')) return <Mail className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('системами аналитики')) return <BarChart3 className="w-8 h-8 text-telegram" />;
    if (lowerTitle.includes('api для мобильных')) return <Smartphone className="w-8 h-8 text-telegram" />; // Предполагаем наличие иконки
...
function getCategoryIcon(category: string): JSX.Element {
  const categoryIcons: Record<string, JSX.Element> = {
    ...
    "КОНТЕНТ": <FileText className="w-8 h-8 text-telegram" />,
    "ФИНТЕХ": <DollarSign className="w-8 h-8 text-telegram" />,
    "СЕРВИСЫ И БРОНИРОВАНИЕ": <Calendar className="w-8 h-8 text-telegram" />,
    "ИНТЕГРАЦИИ": <Link className="w-8 h-8 text-telegram" />,
  };
  return categoryIcons[category] || <Zap className="w-8 h-8 text-telegram" />;
}

// Получаем уникальные категории из общего списка
