...
export const allModulesData: Module[] = [
  ...
  // ИНТЕГРАЦИИ МОДУЛИ (151-160) 
  createModule(
    151,
    "API-конструктор без кода",
    "Создание интеграций с внешними сервисами через визуальный интерфейс",
    "ИНТЕГРАЦИИ",
    [
      "**No-code интерфейс**: Создание интеграций через drag-and-drop без программирования",
      "**Популярные сервисы**: Готовые коннекторы для 100+ популярных API",
      "**Webhook-обработка**: Автоматическая обработка входящих уведомлений",
      "**Трансформация данных**: Конвертация форматов и структур данных на лету",
      "**Мониторинг интеграций**: Отслеживание статуса и производительности подключений"
    ],
    "Сокращение времени интеграции на 90%, снижение технических барьеров",
    "Workflow"
  ),
  ...
  createModule(
    ...
    "Платформа для обучения на протяжении всей жизни",
    "ОБРАЗОВАНИЕ",
    [
      "**Образовательная карьера**: Отслеживание всех этапов обучения пользователя",
      "**Актуализация знаний**: Регулярные курсы повышения квалификации",
      "**Трендовые навыки**: Мониторинг и обучение востребованным компетенциям",
      "**Микрокредиты образования**: Накопление образовательных кредитов разных учреждений",
      "**Профессиональные сообщества**: Сети для обмена опытом и знаниями"
    ],
    "Поддержание актуальности навыков, увеличение карьерных возможностей на 50%",
    "TrendingUp"
  ),
  ...
  createModule(
    ...
    "Визуальный инструмент для создания автоматизированных workflow",
    "АВТОМАТИЗАЦИЯ",
    [
    ...
    "Автоматизация до 80% рутинных операций, снижение ошибок на 95%",
    "Workflow"
  ),
  ...
  createModule(
    ...
    "Специализированное решение для медучреждений",
    "ОТРАСЛЕВЫЕ РЕШЕНИЯ",
    [
    ...
    "Оптимизация загрузки врачей на 40%, сокращение очередей",
    "Stethoscope"
  ),
  ...
  createModule(
    ...
    "Автоматизация спортивных центров",
    "ОТРАСЛЕВЫЕ РЕШЕНИЯ",
    [
    ...
    "Увеличение retention на 45%, рост среднего чека на 30%",
    "Dumbbell"
  ),
  ...
  createModule(
    ...
    "Рост записей на 50%, увеличение среднего чека на 35%",
    "Scissors"
  ),
  ...
  createModule(
    ...
    "Увеличение загрузки на 25%, рост RevPAR на 20%",
    "Hotel"
  ),
  ...
  createModule(
    ...
    "Автоматизация СТО и автомастерских",
    "ОТРАСЛЕВЫЕ РЕШЕНИЯ",
    [
    ...
    "Оптимизация загрузки на 40%, рост выручки на 30%",
    "Car"
  ),
  ...
  createModule(
    ...
    "Специализированная система для стоматологических клиник",
    "ОТРАСЛЕВЫЕ РЕШЕНИЯ",
    [
    ...
    "Увеличение завершенности лечения на 60%, рост LTV пациента",
    "Heart"
  ),
  ...
  createModule(
    ...
    "Увеличение биллинговых часов на 30%, автоматизация рутины",
    "Scale"
  ),
  ...
  createModule(
    ...
    "Система для транспортных и логистических компаний",
    "ОТРАСЛЕВЫЕ РЕШЕНИЯ",
    [
    ...
    "Снижение логистических затрат на 25%, ускорение доставки",
    "Truck"
  ),
  ...
  createModule(
    ...
    "Повышение качества образования, автоматизация отчетности",
    "GraduationCap"
  ),

  // ПРОДВИНУТАЯ АНАЛИТИКА И DATA SCIENCE МОДУЛИ (175-184)
  createModule(
    175,
    "Предиктивная аналитика",
    "Прогнозирование будущих событий на основе данных",
    "АНАЛИТИКА",
    [
    ...
    "Снижение рисков на 40%, оптимизация запасов на 30%",
    "TrendingUp"
  ),
  ...
  // WEB3 И DEFI МОДУЛИ (221-225)
  createModule(
    221,
    "NFT Marketplace",
    "Полноценная торговая площадка для цифровых активов",
    "WEB3 & DEFI",
    [
    ...
    "Новый источник дохода, привлечение крипто-аудитории",
    "Coins"
  ),
  ...
  createModule(
    ...
    "Доходность 10-50% годовых, привлечение инвесторов",
    "TrendingUp"
  ),
  ...
  createModule(
    ...
    "Вовлечение сообщества, децентрализация власти",
    "Users"
  ),
  ...
  createModule(
    ...
    "Создание экономики проекта, рост стоимости токена",
    "Wallet"
  ),
  ...
  createModule(
    225,
    "Web3 Authentication",
    "Авторизация через крипто-кошельки",
    "WEB3 & DEFI",
    [
    ...
    "Безопасность, отсутствие паролей, Web3-нативность",
    "Shield"
  ),

  // ЛОКАЛЬНЫЕ СЕРВИСЫ И ОФЛАЙН БИЗНЕС МОДУЛИ (226-230)
  createModule(
    226,
    "Геолокационный маркетинг",
    "Таргетирование по местоположению пользователя",
    "ЛОКАЛЬНЫЕ СЕРВИСЫ",
    [
    ...
    "Конверсия офлайн-трафика 25%, рост посещаемости",
    "MapPin"
  ),
  ...
  createModule(
    ...
    "Цифровое меню с возможностью заказа",
    "ЛОКАЛЬНЫЕ СЕРВИСЫ",
    [
    ...
    "Увеличение среднего чека на 30%, ускорение обслуживания",
    "QrCode"
  ),
  ...
  createModule(
    ...
    "Система резервирования и управления залом",
    "ЛОКАЛЬНЫЕ СЕРВИСЫ",
    [
    ...
    "Загрузка зала +20%, оптимизация оборота столов",
    "Utensils"
  ),
  ...
  createModule(
    229,
    "Локальная доставка",
    "Система для доставки в пределах района/города",
    "ЛОКАЛЬНЫЕ СЕРВИСЫ",
    [
    ...
    "Снижение стоимости доставки на 40%, скорость",
    "Truck"
  ),
  ...
  createModule(
    ...
    "Гиперлокальная торговая площадка",
    "ЛОКАЛЬНЫЕ СЕРВИСЫ",
    [
    ...
    "Поддержка локального бизнеса, community building",
    "MapPin"
  ),

  // ТРЕНДОВЫЕ ИГРЫ 2024-2025 МОДУЛИ (231-235)
  createModule(
    231,
    "Tap-to-Earn криптоигры",
    "Игры с майнингом токенов через простые действия",
    "ТРЕНДОВЫЕ ИГРЫ",
    [
    ...
    "Виральный рост до 100 млн пользователей, монетизация через внутренние покупки",
    "Gamepad2"
  ),
  ...
  createModule(
    232,
    "Play-to-Earn Battle Royale",
    "Соревновательные игры с криптовалютными наградами",
    "ТРЕНДОВЫЕ ИГРЫ",
    [
  ...
  createModule(
    233,
    "AI-генерируемые квесты",
    "Уникальные приключения, создаваемые нейросетью",
    "ТРЕНДОВЫЕ ИГРЫ",
    [
    ...
    "Неограниченный контент, уникальный опыт для каждого",
    "Wand2"
  ),
  ...
  createModule(
    ...
    "Обучение без риска, привлечение к реальному трейдингу",
    "LineChart"
  ),

  createModule(
    235,
    "Telegram Stars Mining",
    "Майнинг нативной валюты Telegram",
    "ИГРЫ",
    [
    ...
    "Нативная интеграция, 0% комиссия платформы",
    "Star"
  ),

  // ДОПОЛНИТЕЛЬНЫЕ МОДУЛИ ИЗ СПИСКА ПОЛЬЗОВАТЕЛЯ (236-255)
  createModule(
    236,
  ...
  createModule(
    ...
    "Унифицированная система аналитики с консолидацией данных в популярных платформах",
    "МАРКЕТИНГ",
    [
    ...
    "Комплексное понимание поведения пользователей, единый центр аналитики",
    "BarChart3"
  ),
  ...
  createModule(
    ...
    "Экономия до 10 часов рабочего времени аналитиков еженедельно",
    "FileText"
  ),
  ...
  createModule(
    ...
    "Интерактивный механизм геймификации с элементом случайности",
    "ВОВЛЕЧЕНИЕ",
    [
    ...
    "Увеличение показателя возврата пользователей на 25-40%, создание вирусного эффекта",
    "Trophy"
  ),
  ...
  createModule(
    ...
    "Комплексная система планирования работы персонала",
    "БРОНИРОВАНИЕ",
    [
    ...
    "Оптимизация загрузки персонала на 40%, снижение простоев",
    "Calendar"
  ),
  ...
  createModule(
    ...
    "Двусторонняя интеграция с корпоративными календарями",
    "БРОНИРОВАНИЕ",
    [
    ...
    "Устранение двойных бронирований, экономия времени на координацию",
    "Calendar"
  ),
  ...
  createModule(
    ...
    "Интеллектуальная система уведомлений для снижения неявок",
    "БРОНИРОВАНИЕ",
    [
    ...
    "Снижение неявок на 70%, улучшение клиентского опыта",
    "Bell"
  ),
  ...
  createModule(
    ...
    "Система финансовых гарантий для снижения потерь от неявок",
    "БРОНИРОВАНИЕ",
    [
    ...
    "Снижение неявок на 85%, улучшение финансового планирования",
    "CreditCard"
  ),
  ...
  createModule(
    ...
    "Электронная очередь для оптимизации потока клиентов",
    "БРОНИРОВАНИЕ",
    [
    ...
    "Сокращение времени ожидания на 50%, повышение удовлетворенности клиентов",
    "Users"
  ),

  createModule(
    246,
    "Отзывы после оказания услуг",
    "Автоматизированная система сбора обратной связи",
    "БРОНИРОВАНИЕ",
    [
    ...
    "Увеличение количества отзывов на 300%, улучшение репутации",
    "Star"
  ),
  ...
  createModule(
    ...
    "Платформа для проведения удаленных консультаций и встреч",
    "БРОНИРОВАНИЕ",
    [
    ...
    "Расширение географии клиентов, увеличение количества консультаций на 60%",
    "Video"
  ),
  ...
  createModule(
    249,
    "Виртуальные питомцы и тамагочи",
    "Игра с выращиванием и уходом за цифровыми существами",
    "ИГРЫ",
    [
    ...
    "Формирование устойчивой привычки ежедневного использования приложения",
    "Heart"
  ),
  ...
  createModule(
    ...
    "Стратегическая игра с собиранием карт и составлением колод",
    "ИГРЫ",
    [
    ...
    "Высокий потенциал монетизации, долгосрочное удержание пользователей",
    "Trophy"
  ),

  createModule(
    251,
    "AI-тренер и наставник",
    "Персональный коуч для обучения и мотивации",
    "AI-АВАТАРЫ",
    [
    ...
    "Завершаемость курсов +70%, масштабирование без найма тренеров",
    "GraduationCap"
  ),
  ...
  createModule(
    ...
    "AI-рекрутер для автоматизации найма",
    "AI-АВАТАРЫ",
    [
    ...
    "Ускорение найма в 3 раза, экономия на HR-отделе 70%",
    "Users"
  ),
  ...
  createModule(
    ...
    "Виртуальный медконсультант для первичной диагностики",
    "AI-АВАТАРЫ",
    [
    ...
    "Разгрузка врачей на 40%, доступность медпомощи 24/7",
    "Heart"
  ),
  ...
  createModule(
    254,
    "Virtual Event Host",
    "AI-ведущий для онлайн-мероприятий",
    "AI-АВАТАРЫ",
    [
    ...
    "Экономия на ведущих 200к/мероприятие, безупречная работа",
    "Users"
  ),
  ...
  createModule(
    255,
    "AI Content Creator",
    "Автоматическая генерация видеоконтента с аватаром",
    "AI-АВАТАРЫ",
    [
    ...
    "100 видео в день без команды, экономия на продакшне 95%",
    "Video"
  ),

  // ДОПОЛНИТЕЛЬНЫЕ ПРОПУЩЕННЫЕ МОДУЛИ ИЗ СПИСКА ПОЛЬЗОВАТЕЛЯ
  createModule(
    52,
    "Библиотека учебных материалов",
    "Структурированное хранилище образовательного контента с продвинутыми функциями поиска",
    "ОБРАЗОВАНИЕ",
    [
    ...
    "Снижение времени поиска нужной информации на 70%, увеличение глубины изучения материала",
    "BookOpen"
  ),
  ...
  createModule(
    ...
    "Повышение продуктивности на 30%, улучшение коллаборации",
    "Phone"
  ),

  createModule(
    256,
    "Автоматический контент-курирование",
    "Сбор лучшего контента по теме для вашего канала",
    "ПАРСИНГ TELEGRAM",
    [
    ...
    "Экономия 5 часов/день на создании контента, рост подписчиков на 40%",
    "Rss"
  ),

  createModule(
    257,
    "Аудитория конкурентов - анализ и переманивание",
    "Детальный анализ подписчиков конкурентных каналов",
    "ПАРСИНГ TELEGRAM",
    [
    ...
    "Переманивание до 20% аудитории конкурентов, точный таргетинг",
    "Users"
  ),

  createModule(
    258,
    "Партнерский поиск и нетворкинг",
    "Поиск потенциальных партнеров и клиентов B2B",
    "ПАРСИНГ TELEGRAM",
    [
    ...
    "10+ новых B2B-лидов в день, конверсия в партнерства 15%",
    "Handshake"
  ),

  createModule(
    259,
    "Обучающий контент-агрегатор",
    "Сбор образовательного контента для команды",
    "ПАРСИНГ TELEGRAM",
    [
    ...
    "Постоянное развитие команды, экономия на корпоративном обучении",
    "GraduationCap"
  ),

  createModule(
    260,
    "Рекрутинг через парсинг резюме",
    "Поиск кандидатов в профессиональных чатах",
    "ПАРСИНГ TELEGRAM",
    [
    ...
    "Снижение стоимости найма на 70%, доступ к скрытому рынку труда",
    "UserCheck"
  )
];